...
const part0: usb.ConfigurationDescriptor = .{
...
const part1: usb.InterfaceAssociationDescriptor = .{
    .length = @sizeOf(@This()),
    .descriptor_type = .InterfaceAssociation,
    .first_interface = 0,
    .interface_count = 2,
    .function_class = 2, //  TUSB_CLASS_CDC
    .function_subclass = 2, // CDC_COMM_SUBCLASS_ABSTRACT_CONTROL_MODEL 
    .function_protocol = 0, // CDC_COMM_PROTOCOL_NONE
    .function = 0
};

const part2: usb.InterfaceDescriptor = .{
...
const part3: microzig.core.usb.cdc.CdcHeader = .{
    .descriptor_type = .CsInterface,
    .descriptor_subtype = .Header,
    .bcd_cdc = 0x0120
};

const part4: microzig.core.usb.cdc.CdcCallManagement = .{
    .descriptor_type = .CsInterface,
...
const part5: microzig.core.usb.cdc.CdcAcm = .{
    .descriptor_type = .CsInterface,
    .descriptor_subtype = .ACM,
    .capabilities = 6,
};

const part6: microzig.core.usb.cdc.CdcUnion = .{
    .descriptor_type = .CsInterface,
    .descriptor_subtype = .Union,
    .master_interface = 0,
    .slave_interface_0 = 0 + 1
};

const part7: microzig.core.usb.EndpointDescriptor = .{
    .descriptor_type = .Endpoint,
    .endpoint_address = 0x81,
    .attributes = 3,  // TUSB_XFER_INTERRUPT Transfer Type
    .max_packet_size = 8,
    .interval = 16,
};

const part8: microzig.core.usb.InterfaceDescriptor = .{
    .descriptor_type = .Interface,
    .interface_number = 0 + 1,
    .alternate_setting = 0,
    .num_endpoints = 2,
    .interface_class = 10,  // TUSB_CLASS_CDC_DATA
    .interface_subclass = 0,
    .interface_protocol = 0,
    .interface_s = 0
};

const part9: microzig.core.usb.EndpointDescriptor = .{
    .descriptor_type = .Endpoint,
    .endpoint_address = 0x02,
    .attributes = 2,  // TUSB_XFER_BULK
    .max_packet_size = 64,
    .interval = 0,
};

const part10: microzig.core.usb.EndpointDescriptor = .{
    .descriptor_type = .Endpoint,
...
pub var DEVICE_CONFIGURATION: usb.DeviceConfiguration = .{
    ...
    .config_descriptor_alternative = &(part0.serialize() ++ part1.serialize() ++ part2.serialize() ++ part3.serialize() ++ part4.serialize() ++ part5.serialize() ++ part6.serialize() ++ part7.serialize() ++ part8.serialize() ++ part9.serialize() ++ part10.serialize()),
